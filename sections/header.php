...
<header class="fixed top-8 w-full z-40 bg-[#FAFAFA]/70 dark:bg-[#0a0a0a]/80 backdrop-blur-xl transition-colors duration-500 border-b border-black/5 dark:border-white/8">
    <div class="max-w-[1400px] mx-auto px-6 h-16 flex items-center justify-between relative">
        <a href="<?= $basePath ?>" class="font-display font-medium tracking-tight text-xl z-50">
            <b>Digitalsky</b>
        </a>
        ...
        <nav class="hidden md:flex items-center gap-8 text-base font-normal text-slate-500 dark:text-slate-400 absolute left-1/2 -translate-x-1/2">
            <a href="#services"   class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors"><?= $t['nav']['services'] ?></a>
            <a href="#ai"         class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors"><?= $t['nav']['ai'] ?></a>
            <a href="#industries" class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors"><?= $t['nav']['industries'] ?></a>
            <a href="#process"    class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors"><?= $t['nav']['process'] ?></a>
            <a href="#why-us"     class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors"><?= $t['nav']['why'] ?></a>
            <a href="#work"       class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors"><?= $t['nav']['work'] ?></a>
            <a href="#faq"        class="hover:text-blue-600 dark:hover:text-blue-400 transition-colors"><?= $t['nav']['faq'] ?></a>
        </nav>
        ...
        <div class="flex items-center gap-3 z-50">
            ...
            <a href="#contact" class="hidden md:inline-flex items-center justify-center bg-blue-600 text-white text-base font-medium py-2 px-6 rounded-[1rem] hover:bg-blue-700 transition-colors duration-300"><?= $t['nav']['cta'] ?></a>
