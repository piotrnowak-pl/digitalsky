...
<header class="fixed top-8 w-full z-40 bg-[#FAFAFA]/70 dark:bg-[#0a0a0a]/80 backdrop-blur-xl transition-colors duration-500 border-b border-black/5 dark:border-white/8">
    <div class="max-w-[1400px] mx-auto px-6 h-16 flex items-center justify-between relative">
        ...
        <nav class="hidden md:flex items-center gap-5 text-sm font-normal text-slate-700 dark:text-slate-300 absolute left-1/2 -translate-x-1/2">
        ...
        <div class="flex items-center gap-3 z-50">
            ...
            <a href="#contact" class="hidden md:inline-flex items-center justify-center bg-blue-600 text-white text-sm font-medium py-2 px-6 rounded-[1rem] hover:bg-blue-700 transition-colors duration-300"><?= $t['nav']['cta'] ?></a>
